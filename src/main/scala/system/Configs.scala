...
class SpectreDevBoomConfig extends Config(new WithSpectreDevBooms ++ new DefaultBoomConfig ++ new WithNBoomCores(1) ++ new WithoutTLMonitors ++ new freechips.rocketchip.system.BaseConfig)
